...
public class LongestPalindromicSubstringSizeMemoizationSearchTest {
    ...
    public void shouldSearchCaseNullString() {
        ...
        // When
        final ThrowableAssert.ThrowingCallable result = () -> LongestPalindromicSubstringSizeDynamicSearch.search(string);
