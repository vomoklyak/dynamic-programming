...
public class MinCoinChangeRecursiveSearchTest {
    ...
    public void shouldSearch() {
        ...
        // When
        final Optional<Integer> result = MinCoinChangeRecursiveSearch.search(sum, denominations);
    ...
    public void shouldSearchCaseNegativeSum() {
        ...
        // When
        final ThrowableAssert.ThrowingCallable result = () -> MinCoinChangeRecursiveSearch.search(sum, denominations);
