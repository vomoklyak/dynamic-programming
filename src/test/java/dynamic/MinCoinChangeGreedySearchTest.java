...
public class MinCoinChangeGreedySearchTest {
    ...
    public void shouldSearch() {
        ...
        // When
        final Optional<Integer> result = MinCoinChangeGreedySearch.search(sum, denominations);
    ...
    public void shouldSearchCaseNegativeSum() {
        ...
        // When
        final ThrowableAssert.ThrowingCallable result = () -> MinCoinChangeGreedySearch.search(sum, denominations);
    ...
    @Test
    public void shouldSearchCoins() {
        // Given
        final int sum = 11;
        final List<Integer> denominations = Arrays.asList(1, 2, 3);

        // When
        final Optional<List<Integer>> result = MinCoinChangeGreedySearch.searchCoins(sum, denominations);

        // Then
        Assertions.assertThat(result).get().isEqualTo(Arrays.asList(3, 3, 3, 2));
    }
